        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <form class="custom-form contact-form row" action="lib/process_contact.php" method="post" role="form">
                        ...
                        <div class="col-lg-6 col-6">
                            ...
                            <input type="tel" name="contact-phone" id="contact-phone" pattern="[0-9]{10}" class="form-control" placeholder="09xxxxxxxx">
                        </div>
                        <div class="col-12">
                ...
                <div class="col-lg-4 col-12 mx-auto mt-lg-5 mt-4">
                    ...
                    <div class="d-flex mb-lg-3">
                        ...
                        <p class="ms-5">10:00 AM - 09:00 PM</p>
                    </div>
                    <h5>Weekends</h5>
                    <div class="d-flex">
