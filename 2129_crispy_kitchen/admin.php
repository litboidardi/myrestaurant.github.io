                    ...
                    <div class="team-thumb">
                        ...
                        foreach ($reservationData as $reservation) : ?>
                            <div class="news-author d-flex flex-wrap align-items-center">
                                ...
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#BookingModal"<?php echo $reservation['id']; ?>">
                                    Update
                                </button>
            ...
            <div class="modal-body d-flex flex-column justify-content-center">
                <div class="booking">
                    ...
                    <div class="col-lg-4 col-12 ms-auto">
                        <button type="submit" class="form-control" data-bs-dismiss="modal" onclick="updateReservation(<?php echo $reservation['id']; ?>)">Submit Request</button>
                    </div>
                    </form>
                </div>
            </div>
